...
const upload = () => {
  ...
  return (
    <main className="min-h-screen w-full bg-[url('/images/bg-main.svg')] bg-no-repeat bg-cover bg-fixed">
    <Navbar/>
        ...
        <div className='page-heading py=16'>
            ...
            {isProcessing ? (
                <div className="flex flex-col items-center justify-center min-h-[60vh]">
                    <h2 className="text-center mb-6">{statustext}</h2>
                    <img src="/images/resume-scan.gif" className='w-96 max-w-[80vw] h-auto' alt="" />
                </div>
            ):(
